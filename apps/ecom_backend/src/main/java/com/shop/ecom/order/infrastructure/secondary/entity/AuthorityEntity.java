package com.shop.ecom.order.infrastructure.secondary.entity;

import com.shop.ecom.order.domain.user.aggregate.Authority;
import com.shop.ecom.order.domain.user.aggregate.AuthorityBuilder;
